...
import ec.mil.he1.pom_01_domain.Cuentas;
...
import ec.mil.he1.pom_04_portalservicios.beanpackage.CuentasFacade;
...
public class CuentasController implements Serializable {
    ...
    @EJB
    private ec.mil.he1.pom_04_portalservicios.beanpackage.CuentasFacade ejbFacade;
    ...
    public Cuentas getSelected() {
        if (current == null) {
            current = new Cuentas();
            current.setCuentasPK(new ec.mil.he1.pom_01_domain.CuentasPK());
            selectedItemIndex = -1;
        }
        return current;
    }
    ...
    public Cuentas getCuentas(ec.mil.he1.pom_01_domain.CuentasPK id) {
    ...
    public static class CuentasControllerConverter implements Converter {
        ...
        ec.mil.he1.pom_01_domain.CuentasPK getKey(String value) {
            ec.mil.he1.pom_01_domain.CuentasPK key;
            String values[] = value.split(SEPARATOR_ESCAPED);
            key = new ec.mil.he1.pom_01_domain.CuentasPK();
            key.setDocumento(values[0]);
            key.setNumero(Long.parseLong(values[1]));
            key.setDetalle(Integer.parseInt(values[2]));
            key.setSeguro(new Character(values[3].charAt(0)));
            return key;
        }

        String getStringKey(ec.mil.he1.pom_01_domain.CuentasPK value) {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Cuentas) {
                ...
                return getStringKey(o.getCuentasPK());
            } else {
