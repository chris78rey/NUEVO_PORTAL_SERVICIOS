...
import ec.mil.he1.pom_04_portalservicios.beanpackage.ParroquiasFacade;
...
public class ParroquiasController implements Serializable {
    ...
    @EJB
    private ec.mil.he1.pom_04_portalservicios.beanpackage.ParroquiasFacade ejbFacade;
    ...
    public Parroquias getSelected() {
        if (current == null) {
            ...
            current.setParroquiasPK(new ec.mil.he1.pom_01_domain.ParroquiasPK());
            selectedItemIndex = -1;
        }
        return current;
    }
    ...
    public Parroquias getParroquias(ec.mil.he1.pom_01_domain.ParroquiasPK id) {
    ...
    public static class ParroquiasControllerConverter implements Converter {
        ...
        ec.mil.he1.pom_01_domain.ParroquiasPK getKey(String value) {
            ec.mil.he1.pom_01_domain.ParroquiasPK key;
            String values[] = value.split(SEPARATOR_ESCAPED);
            key = new ec.mil.he1.pom_01_domain.ParroquiasPK();
        ...
        String getStringKey(ec.mil.he1.pom_01_domain.ParroquiasPK value) {
