...
import ec.mil.he1.pom_02_domain.entities.Ocupaciones;
...
import ec.mil.he1.pom_04_portalservicios.sessionbean.OcupacionesFacade;
...
public class OcupacionesController implements Serializable {
    ...
    @EJB
    private ec.mil.he1.pom_04_portalservicios.sessionbean.OcupacionesFacade ejbFacade;
    ...
    public String prepareView() {
        current = (Ocupaciones) getItems().getRowData();
    ...
    public String create() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("OcupacionesCreated"));
    ...
    public String update() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("OcupacionesUpdated"));
            return "View";
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
            return null;
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("OcupacionesDeleted"));
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
        }
    }
    ...
    public Ocupaciones getOcupaciones(java.lang.String id) {
    ...
    public static class OcupacionesControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            return controller.getOcupaciones(getKey(value));
        }
