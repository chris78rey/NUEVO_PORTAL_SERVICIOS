...
import ec.mil.he1.pom_01_domain.Banco;
...
import ec.mil.he1.pom_04_portalservicios.beanpackage.BancoFacade;
...
public class BancoController implements Serializable {
    ...
    @EJB
    private ec.mil.he1.pom_04_portalservicios.beanpackage.BancoFacade ejbFacade;
    ...
    public static class BancoControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Banco) {
                ...
                return getStringKey(o.getBanIdbanco());
            } else {
