...
import ec.mil.he1.pom_01_domain.Departamentos;
...
import ec.mil.he1.pom_04_portalservicios.beanpackage.DepartamentosFacade;
...
public class DepartamentosController implements Serializable {
    ...
    @EJB
    private ec.mil.he1.pom_04_portalservicios.beanpackage.DepartamentosFacade ejbFacade;
    ...
    public Departamentos getSelected() {
        if (current == null) {
            ...
            current.setDepartamentosPK(new ec.mil.he1.pom_01_domain.DepartamentosPK());
            selectedItemIndex = -1;
        }
        return current;
    }
    ...
    public Departamentos getDepartamentos(ec.mil.he1.pom_01_domain.DepartamentosPK id) {
    ...
    public static class DepartamentosControllerConverter implements Converter {
        ...
        ec.mil.he1.pom_01_domain.DepartamentosPK getKey(String value) {
            ec.mil.he1.pom_01_domain.DepartamentosPK key;
            String values[] = value.split(SEPARATOR_ESCAPED);
            key = new ec.mil.he1.pom_01_domain.DepartamentosPK();
            key.setAraCodigo(values[0]);
            key.setCodigo(values[1]);
            return key;
        }

        String getStringKey(ec.mil.he1.pom_01_domain.DepartamentosPK value) {
            StringBuilder sb = new StringBuilder();
            sb.append(value.getAraCodigo());
            sb.append(SEPARATOR);
