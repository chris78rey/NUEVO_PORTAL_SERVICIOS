...
import ec.mil.he1.pom_02_domain.entities.Pacientes;
...
import ec.mil.he1.pom_04_portalservicios.sessionbean.PacientesFacade;
...
public class PacientesController implements Serializable {
    ...
    @EJB
    private ec.mil.he1.pom_04_portalservicios.sessionbean.PacientesFacade ejbFacade;
    ...
    public static class PacientesControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Pacientes) {
                ...
                return getStringKey(o.getNumeroHc());
            } else {
