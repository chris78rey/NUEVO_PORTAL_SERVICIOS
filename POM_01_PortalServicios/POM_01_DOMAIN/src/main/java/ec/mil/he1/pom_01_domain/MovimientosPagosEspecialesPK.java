...
public class MovimientosPagosEspecialesPK implements Serializable {
    ...
    public String toString() {
        return "ec.mil.he1.pom_01_domain.MovimientosPagosEspecialesPK[ pagespprmespPrmrolEmpCodigo=" + pagespprmespPrmrolEmpCodigo + ", pagespPrmespPrmrolCodigo=" + pagespPrmespPrmrolCodigo + ", emprolEmpCodigo=" + emprolEmpCodigo + ", emprolCodigo=" + emprolCodigo + ", pagespNumero=" + pagespNumero + " ]";
    }
