...
public class ComercialesSnsPK implements Serializable {
    ...
    public String toString() {
        return "ec.mil.he1.pom_01_domain.ComercialesSnsPK[ trfitmCnvConvenio=" + trfitmCnvConvenio + ", trtitmAtiAnexo=" + trtitmAtiAnexo + ", trfitmTipo=" + trfitmTipo + ", trfitmCodigo=" + trfitmCodigo + ", codigo=" + codigo + " ]";
    }
