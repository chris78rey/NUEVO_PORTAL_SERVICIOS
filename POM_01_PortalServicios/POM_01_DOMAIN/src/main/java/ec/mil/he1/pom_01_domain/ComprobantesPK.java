...
public class ComprobantesPK implements Serializable {
    ...
    public String toString() {
        return "ec.mil.he1.pom_01_domain.ComprobantesPK[ fecha=" + fecha + ", clave=" + clave + ", tpocmpempTpocmpCodigo=" + tpocmpempTpocmpCodigo + ", tpocmpempEmpCodigo=" + tpocmpempEmpCodigo + " ]";
    }
