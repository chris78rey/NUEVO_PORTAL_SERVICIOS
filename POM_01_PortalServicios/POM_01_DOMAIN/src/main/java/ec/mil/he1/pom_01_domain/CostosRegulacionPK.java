...
public class CostosRegulacionPK implements Serializable {
    ...
    public String toString() {
        return "ec.mil.he1.pom_01_domain.CostosRegulacionPK[ dtlcrrItmCodigo=" + dtlcrrItmCodigo + ", dtlcrrItmSbsCodigo=" + dtlcrrItmSbsCodigo + ", dtlcrrItmSbsSccCodigo=" + dtlcrrItmSbsSccCodigo + ", dtlcrrItmTipo=" + dtlcrrItmTipo + ", dtlcrrRgtcrrAnio=" + dtlcrrRgtcrrAnio + ", dtlcrrRgtcrrLocal=" + dtlcrrRgtcrrLocal + ", dtlcrrRgtcrrMes=" + dtlcrrRgtcrrMes + ", tipo=" + tipo + " ]";
    }
