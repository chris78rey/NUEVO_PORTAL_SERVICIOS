...
public class DetallesVariableProtocoloPK implements Serializable {
    ...
    public String toString() {
        return "ec.mil.he1.pom_01_domain.DetallesVariableProtocoloPK[ sdvpCodigo=" + sdvpCodigo + ", sdvpVpCodigo=" + sdvpVpCodigo + ", sdvpVrbpPrtCodigo=" + sdvpVrbpPrtCodigo + ", codigo=" + codigo + " ]";
    }
