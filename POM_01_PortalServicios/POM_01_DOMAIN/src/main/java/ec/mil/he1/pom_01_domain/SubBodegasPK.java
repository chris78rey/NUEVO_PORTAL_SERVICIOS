...
public class SubBodegasPK implements Serializable {
    ...
    public String toString() {
        return "ec.mil.he1.pom_01_domain.SubBodegasPK[ itmTipo=" + itmTipo + ", itmSbsSccCodigo=" + itmSbsSccCodigo + ", itmSbsCodigo=" + itmSbsCodigo + ", itmCodigo=" + itmCodigo + ", dprCodigo=" + dprCodigo + ", dprAraCodigo=" + dprAraCodigo + " ]";
    }
