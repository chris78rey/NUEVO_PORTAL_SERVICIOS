...
public class RegistrosTransAnestesicosPK implements Serializable {
    ...
    public String toString() {
        return "ec.mil.he1.pom_01_domain.RegistrosTransAnestesicosPK[ rgsoprPrtoprslcNumero=" + rgsoprPrtoprslcNumero + ", rgsoprPrtoprslcPcnNumeroHc=" + rgsoprPrtoprslcPcnNumeroHc + ", fila=" + fila + ", columna=" + columna + ", tipo=" + tipo + " ]";
    }
