...
public class CuentasExtrasPK implements Serializable {
    ...
    public String toString() {
        return "ec.mil.he1.pom_01_domain.CuentasExtrasPK[ cntsDocumento=" + cntsDocumento + ", cntsNumero=" + cntsNumero + ", cntsDetalle=" + cntsDetalle + ", cntsSeguro=" + cntsSeguro + ", sessionId=" + sessionId + " ]";
    }
