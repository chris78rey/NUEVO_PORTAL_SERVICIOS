...
public class RetencionesVentasSriPK implements Serializable {
    ...
    public String toString() {
        return "ec.mil.he1.pom_01_domain.RetencionesVentasSriPK[ vntsriIvaEmpCodigo=" + vntsriIvaEmpCodigo + ", vntsriIvaPeriodo=" + vntsriIvaPeriodo + ", vntsriNumero=" + vntsriNumero + ", codigoRf=" + codigoRf + " ]";
    }
