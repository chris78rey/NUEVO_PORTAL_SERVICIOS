...
public class PostAnesMedicamentosPK implements Serializable {
    ...
    public String toString() {
        return "ec.mil.he1.pom_01_domain.PostAnesMedicamentosPK[ pstansRgsoprPrtoprslcPcnNu=" + pstansRgsoprPrtoprslcPcnNu + ", pstansRgsoprPrtoprslcNumero=" + pstansRgsoprPrtoprslcNumero + ", hora=" + hora + " ]";
    }
