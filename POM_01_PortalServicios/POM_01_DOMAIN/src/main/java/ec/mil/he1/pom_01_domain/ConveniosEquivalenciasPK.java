...
public class ConveniosEquivalenciasPK implements Serializable {
    ...
    public String toString() {
        return "ec.mil.he1.pom_01_domain.ConveniosEquivalenciasPK[ crgCodigo=" + crgCodigo + ", crgTipo=" + crgTipo + ", cnvtrfConvenio=" + cnvtrfConvenio + ", cnvtrfCodigo=" + cnvtrfCodigo + ", tipo=" + tipo + " ]";
    }
