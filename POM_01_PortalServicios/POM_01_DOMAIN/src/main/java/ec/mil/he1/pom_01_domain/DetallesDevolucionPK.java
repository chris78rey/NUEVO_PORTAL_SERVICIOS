...
public class DetallesDevolucionPK implements Serializable {
    ...
    public String toString() {
        return "ec.mil.he1.pom_01_domain.DetallesDevolucionPK[ dvlNumero=" + dvlNumero + ", dtlfctDocumento=" + dtlfctDocumento + ", dtlfctFctNumero=" + dtlfctFctNumero + ", dtlfctNumero=" + dtlfctNumero + ", dtlfctDetalle=" + dtlfctDetalle + " ]";
    }
