...
public class DetallesPlanillaPrefactPK implements Serializable {
    ...
    public String toString() {
        return "ec.mil.he1.pom_01_domain.DetallesPlanillaPrefactPK[ cntsDocumento=" + cntsDocumento + ", cntsDetalle=" + cntsDetalle + ", cntsNumero=" + cntsNumero + ", plaNumeroPlanilla=" + plaNumeroPlanilla + " ]";
    }
