...
public class SubauxiliaresPK implements Serializable {
    ...
    public String toString() {
        return "ec.mil.he1.pom_01_domain.SubauxiliaresPK[ aScCntMyrEmpCodigo=" + aScCntMyrEmpCodigo + ", aScCntMyrCodigo=" + aScCntMyrCodigo + ", aScCntCodigo=" + aScCntCodigo + ", aScCodigo=" + aScCodigo + ", aCodigo=" + aCodigo + ", codigo=" + codigo + " ]";
    }
