...
public class Subgrupos2TarifarioPK implements Serializable {
    ...
    public String toString() {
        return "ec.mil.he1.pom_01_domain.Subgrupos2TarifarioPK[ convenio=" + convenio + ", tipo=" + tipo + ", sbg1trfGrptrfCodigo=" + sbg1trfGrptrfCodigo + ", sbg1trfSbgtrfCodigo=" + sbg1trfSbgtrfCodigo + ", sbg1trfCodigo=" + sbg1trfCodigo + ", codigo=" + codigo + " ]";
    }
