...
public class IngresosDeBodega implements Serializable {
    ...
    @Column(name = "PRS_CODIGO_INSPECCIONADO_POR")
    private String prsCodigoInspeccionadoPor;
    ...
    public String getPrsCodigoInspeccionadoPor() {
        return prsCodigoInspeccionadoPor;
    }

    public void setPrsCodigoInspeccionadoPor(String prsCodigoInspeccionadoPor) {
        this.prsCodigoInspeccionadoPor = prsCodigoInspeccionadoPor;
    }
    ...
    public String toString() {
        return "ec.mil.he1.pom_01_domain.IngresosDeBodega[ ingresosDeBodegaPK=" + ingresosDeBodegaPK + " ]";
    }
