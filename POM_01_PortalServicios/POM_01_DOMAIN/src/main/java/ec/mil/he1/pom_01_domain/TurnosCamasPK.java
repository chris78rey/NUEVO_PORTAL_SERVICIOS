...
public class TurnosCamasPK implements Serializable {
    ...
    public String toString() {
        return "ec.mil.he1.pom_01_domain.TurnosCamasPK[ fecha=" + fecha + ", ocupada=" + ocupada + ", cmahspSala=" + cmahspSala + ", cmahspCama=" + cmahspCama + ", prmNumero=" + prmNumero + ", prmPcnNumeroHc=" + prmPcnNumeroHc + ", numeroAlta=" + numeroAlta + " ]";
    }
