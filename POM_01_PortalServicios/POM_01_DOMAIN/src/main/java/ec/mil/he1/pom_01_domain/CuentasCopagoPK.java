...
public class CuentasCopagoPK implements Serializable {
    ...
    public String toString() {
        return "ec.mil.he1.pom_01_domain.CuentasCopagoPK[ cntsDocumento=" + cntsDocumento + ", cntsNumero=" + cntsNumero + ", cntsDetalle=" + cntsDetalle + ", cpgpcnCpgpcnId=" + cpgpcnCpgpcnId + " ]";
    }
