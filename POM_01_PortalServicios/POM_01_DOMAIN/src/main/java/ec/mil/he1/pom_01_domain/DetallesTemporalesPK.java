...
public class DetallesTemporalesPK implements Serializable {
    ...
    public String toString() {
        return "ec.mil.he1.pom_01_domain.DetallesTemporalesPK[ egrbtcNumero=" + egrbtcNumero + ", egrbtcTipo=" + egrbtcTipo + ", itmCodigo=" + itmCodigo + ", itmSbsCodigo=" + itmSbsCodigo + ", itmSbsSccCodigo=" + itmSbsSccCodigo + ", itmTipo=" + itmTipo + " ]";
    }
