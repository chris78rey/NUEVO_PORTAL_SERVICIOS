...
public class DetallesFormulasPK implements Serializable {
    ...
    public String toString() {
        return "ec.mil.he1.pom_01_domain.DetallesFormulasPK[ grpdtlFrmrolEmpCodigo=" + grpdtlFrmrolEmpCodigo + ", grpdtlFrmrolCodigo=" + grpdtlFrmrolCodigo + ", grpdtlSecuencia=" + grpdtlSecuencia + ", numero=" + numero + " ]";
    }
