...
public class DetallesContabilizacionCrr implements Serializable {
    ...
    @Column(name = "CNTCRRMES_CNTCRRMES_ID")
    private Long cntcrrmesCntcrrmesId;
    ...
    public Long getCntcrrmesCntcrrmesId() {
        return cntcrrmesCntcrrmesId;
    }

    public void setCntcrrmesCntcrrmesId(Long cntcrrmesCntcrrmesId) {
        this.cntcrrmesCntcrrmesId = cntcrrmesCntcrrmesId;
    }
    ...
    public String toString() {
        return "ec.mil.he1.pom_01_domain.DetallesContabilizacionCrr[ dtlcntcrrId=" + dtlcntcrrId + " ]";
    }
