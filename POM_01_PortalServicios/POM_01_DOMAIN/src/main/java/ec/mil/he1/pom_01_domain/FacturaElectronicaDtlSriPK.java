...
public class FacturaElectronicaDtlSriPK implements Serializable {
    ...
    public String toString() {
        return "ec.mil.he1.pom_01_domain.FacturaElectronicaDtlSriPK[ dtlDocumento=" + dtlDocumento + ", dtlNumero=" + dtlNumero + ", dtlDetalle=" + dtlDetalle + ", fctCaja=" + fctCaja + ", fctNumero=" + fctNumero + ", dtlSeguro=" + dtlSeguro + " ]";
    }
