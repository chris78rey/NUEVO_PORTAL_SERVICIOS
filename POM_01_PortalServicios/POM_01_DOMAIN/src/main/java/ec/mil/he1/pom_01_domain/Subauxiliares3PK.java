...
public class Subauxiliares3PK implements Serializable {
    ...
    public String toString() {
        return "ec.mil.he1.pom_01_domain.Subauxiliares3PK[ sSAScCntMyrEmpCodigo=" + sSAScCntMyrEmpCodigo + ", sSAScCntMyrCodigo=" + sSAScCntMyrCodigo + ", sSAScCntCodigo=" + sSAScCntCodigo + ", sSAScCodigo=" + sSAScCodigo + ", sSACodigo=" + sSACodigo + ", sSCodigo=" + sSCodigo + ", sCodigo=" + sCodigo + ", codigo=" + codigo + " ]";
    }
