...
public class CostosAdicionalesPK implements Serializable {
    ...
    public String toString() {
        return "ec.mil.he1.pom_01_domain.CostosAdicionalesPK[ elmcstprdElmcstNumero=" + elmcstprdElmcstNumero + ", elmcstprdPrdNumero=" + elmcstprdPrdNumero + ", costoAdicional=" + costoAdicional + " ]";
    }
