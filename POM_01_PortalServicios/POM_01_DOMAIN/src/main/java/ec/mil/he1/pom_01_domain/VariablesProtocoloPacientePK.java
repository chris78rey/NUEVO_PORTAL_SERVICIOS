...
public class VariablesProtocoloPacientePK implements Serializable {
    ...
    public String toString() {
        return "ec.mil.he1.pom_01_domain.VariablesProtocoloPacientePK[ ppPcnHc=" + ppPcnHc + ", ppPCodigo=" + ppPCodigo + ", ppFecha=" + ppFecha + ", vpCodigo=" + vpCodigo + ", vpPCodigo=" + vpPCodigo + " ]";
    }
