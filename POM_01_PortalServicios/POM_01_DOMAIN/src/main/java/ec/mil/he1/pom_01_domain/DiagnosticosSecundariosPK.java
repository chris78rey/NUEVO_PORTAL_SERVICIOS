...
public class DiagnosticosSecundariosPK implements Serializable {
    ...
    public String toString() {
        return "ec.mil.he1.pom_01_domain.DiagnosticosSecundariosPK[ epcPrmatnNumero=" + epcPrmatnNumero + ", epcPrmatnPcnNumeroHc=" + epcPrmatnPcnNumeroHc + ", dgnpcnDgnpcnId=" + dgnpcnDgnpcnId + " ]";
    }
