...
public class AtencionesPromocionesCargosPK implements Serializable {
    ...
    public String toString() {
        return "ec.mil.he1.pom_01_domain.AtencionesPromocionesCargosPK[ tipoAtencion=" + tipoAtencion + ", clasificacionPaciente=" + clasificacionPaciente + ", estadoDeDisponibilidad=" + estadoDeDisponibilidad + " ]";
    }
