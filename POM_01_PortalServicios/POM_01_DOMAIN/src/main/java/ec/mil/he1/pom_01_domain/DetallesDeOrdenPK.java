...
public class DetallesDeOrdenPK implements Serializable {
    ...
    public String toString() {
        return "ec.mil.he1.pom_01_domain.DetallesDeOrdenPK[ ordcmpNumero=" + ordcmpNumero + ", dtlcmpItmTipo=" + dtlcmpItmTipo + ", dtlcmpItmSbsSccCodigo=" + dtlcmpItmSbsSccCodigo + ", dtlcmpItmSbsCodigo=" + dtlcmpItmSbsCodigo + ", dtlcmpItmCodigo=" + dtlcmpItmCodigo + " ]";
    }
