...
public class ComplementosAResultadosPK implements Serializable {
    ...
    public String toString() {
        return "ec.mil.he1.pom_01_domain.ComplementosAResultadosPK[ cmplmtCodigo=" + cmplmtCodigo + ", dtlexmExmNumero=" + dtlexmExmNumero + ", dtlexmVrbexmCodigo=" + dtlexmVrbexmCodigo + " ]";
    }
