...
public class DetallesAjustesPK implements Serializable {
    ...
    public String toString() {
        return "ec.mil.he1.pom_01_domain.DetallesAjustesPK[ daSecuencia=" + daSecuencia + ", itmSbsCodigo=" + itmSbsCodigo + ", itmCodigo=" + itmCodigo + ", itmSbsSccCodigo=" + itmSbsSccCodigo + ", itmTipo=" + itmTipo + " ]";
    }
