...
public class DetallesMovimientosBancos implements Serializable {
    ...
    @Column(name = "MVMBNCCNT_MVMBNCCNT_ID")
    private Integer mvmbnccntMvmbnccntId;
    @Id
    ...
    public Integer getMvmbnccntMvmbnccntId() {
        return mvmbnccntMvmbnccntId;
    }

    public void setMvmbnccntMvmbnccntId(Integer mvmbnccntMvmbnccntId) {
        this.mvmbnccntMvmbnccntId = mvmbnccntMvmbnccntId;
    }
    ...
    public String toString() {
        return "ec.mil.he1.pom_01_domain.DetallesMovimientosBancos[ dtlmvmbncId=" + dtlmvmbncId + " ]";
    }
