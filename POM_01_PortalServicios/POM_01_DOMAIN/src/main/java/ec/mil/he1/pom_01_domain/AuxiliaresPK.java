...
public class AuxiliaresPK implements Serializable {
    ...
    public String toString() {
        return "ec.mil.he1.pom_01_domain.AuxiliaresPK[ scCntMyrEmpCodigo=" + scCntMyrEmpCodigo + ", scCntMyrCodigo=" + scCntMyrCodigo + ", scCntCodigo=" + scCntCodigo + ", scCodigo=" + scCodigo + ", codigo=" + codigo + " ]";
    }
