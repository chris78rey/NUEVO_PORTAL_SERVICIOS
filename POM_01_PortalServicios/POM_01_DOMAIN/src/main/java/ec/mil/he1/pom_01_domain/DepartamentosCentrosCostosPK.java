...
public class DepartamentosCentrosCostosPK implements Serializable {
    ...
    public String toString() {
        return "ec.mil.he1.pom_01_domain.DepartamentosCentrosCostosPK[ dprAraCodigo=" + dprAraCodigo + ", dprCodigo=" + dprCodigo + ", cntcstEmpCodigo=" + cntcstEmpCodigo + ", cntcstTipo=" + cntcstTipo + ", cntcstAgrupador=" + cntcstAgrupador + " ]";
    }
