...
public class Consultas implements Serializable {
    ...
    @Column(name = "TRN_CE_NUMERO_ID")
    private Integer trnCeNumeroId;
    @Column(name = "FECHA")
    ...
    public Integer getTrnCeNumeroId() {
        return trnCeNumeroId;
    }

    public void setTrnCeNumeroId(Integer trnCeNumeroId) {
        this.trnCeNumeroId = trnCeNumeroId;
    }
    ...
    public String toString() {
        return "ec.mil.he1.pom_01_domain.Consultas[ numero=" + numero + " ]";
    }
