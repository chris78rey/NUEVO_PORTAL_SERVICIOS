...
public class ComplicacionesPostanestesicasPK implements Serializable {
    ...
    public String toString() {
        return "ec.mil.he1.pom_01_domain.ComplicacionesPostanestesicasPK[ prtoprslcPcnNumeroHc=" + prtoprslcPcnNumeroHc + ", prtoprslcNumero=" + prtoprslcNumero + ", complicacion=" + complicacion + " ]";
    }
