...
public class ItemsProveedoresPK implements Serializable {
    ...
    public String toString() {
        return "ec.mil.he1.pom_01_domain.ItemsProveedoresPK[ itmTipo=" + itmTipo + ", itmSbsSccCodigo=" + itmSbsSccCodigo + ", itmSbsCodigo=" + itmSbsCodigo + ", itmCodigo=" + itmCodigo + ", prdCodigo=" + prdCodigo + " ]";
    }
