...
public class IngredientesPK implements Serializable {
    ...
    public String toString() {
        return "ec.mil.he1.pom_01_domain.IngredientesPK[ mnuId=" + mnuId + ", itmSbsSccCodigo=" + itmSbsSccCodigo + ", itmSbsCodigo=" + itmSbsCodigo + ", itmCodigo=" + itmCodigo + ", itmTipo=" + itmTipo + " ]";
    }
