...
public class ProcedimientosSolicitadosPK implements Serializable {
    ...
    public String toString() {
        return "ec.mil.he1.pom_01_domain.ProcedimientosSolicitadosPK[ prtoprslcPcnNumeroHc=" + prtoprslcPcnNumeroHc + ", prtoprslcNumero=" + prtoprslcNumero + ", prchspCodigo=" + prchspCodigo + " ]";
    }
