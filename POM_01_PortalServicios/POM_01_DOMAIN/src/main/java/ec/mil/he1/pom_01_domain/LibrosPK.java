...
public class LibrosPK implements Serializable {
    ...
    public String toString() {
        return "ec.mil.he1.pom_01_domain.LibrosPK[ cntbncEmpCodigo=" + cntbncEmpCodigo + ", cntbncTipo=" + cntbncTipo + ", cntbncNumero=" + cntbncNumero + ", tpomvmCodigo=" + tpomvmCodigo + ", numero=" + numero + " ]";
    }
