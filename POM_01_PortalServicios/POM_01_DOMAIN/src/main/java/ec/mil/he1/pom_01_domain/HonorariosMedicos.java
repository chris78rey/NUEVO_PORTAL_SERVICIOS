...
public class HonorariosMedicos implements Serializable {
    ...
    @Column(name = "ENTBNF_CODIGO_GRUPAL")
    private Integer entbnfCodigoGrupal;
    @Column(name = "ENTBNF_MSTBNF_GRUPAL")
    private String entbnfMstbnfGrupal;
    ...
    public Integer getEntbnfCodigoGrupal() {
        return entbnfCodigoGrupal;
    }

    public void setEntbnfCodigoGrupal(Integer entbnfCodigoGrupal) {
        this.entbnfCodigoGrupal = entbnfCodigoGrupal;
    }

    public String getEntbnfMstbnfGrupal() {
        return entbnfMstbnfGrupal;
    }

    public void setEntbnfMstbnfGrupal(String entbnfMstbnfGrupal) {
        this.entbnfMstbnfGrupal = entbnfMstbnfGrupal;
    }
    ...
    public String toString() {
        return "ec.mil.he1.pom_01_domain.HonorariosMedicos[ honorariosMedicosPK=" + honorariosMedicosPK + " ]";
    }
