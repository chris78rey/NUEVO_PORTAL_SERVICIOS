...
public class DetalleCreacionNovedades implements Serializable {
    ...
    @Column(name = "CRCNVDFCT_CRCNVDFCT_ID")
    private Integer crcnvdfctCrcnvdfctId;
    @Id
    ...
    public Integer getCrcnvdfctCrcnvdfctId() {
        return crcnvdfctCrcnvdfctId;
    }

    public void setCrcnvdfctCrcnvdfctId(Integer crcnvdfctCrcnvdfctId) {
        this.crcnvdfctCrcnvdfctId = crcnvdfctCrcnvdfctId;
    }
    ...
    public String toString() {
        return "ec.mil.he1.pom_01_domain.DetalleCreacionNovedades[ dtlcrcnvdId=" + dtlcrcnvdId + " ]";
    }
