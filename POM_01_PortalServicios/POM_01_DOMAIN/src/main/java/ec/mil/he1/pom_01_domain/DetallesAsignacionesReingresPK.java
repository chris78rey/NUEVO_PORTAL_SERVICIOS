...
public class DetallesAsignacionesReingresPK implements Serializable {
    ...
    public String toString() {
        return "ec.mil.he1.pom_01_domain.DetallesAsignacionesReingresPK[ asgrinactEmpCodigo=" + asgrinactEmpCodigo + ", asgrinactTipoMovimiento=" + asgrinactTipoMovimiento + ", asgrinactNumero=" + asgrinactNumero + ", numero=" + numero + " ]";
    }
