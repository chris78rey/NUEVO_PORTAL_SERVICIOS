...
public class ClasificacionManoDeObraPK implements Serializable {
    ...
    public String toString() {
        return "ec.mil.he1.pom_01_domain.ClasificacionManoDeObraPK[ prdNumero=" + prdNumero + ", mnoobrTipo=" + mnoobrTipo + ", mnoobrCodigo=" + mnoobrCodigo + ", clasificacion=" + clasificacion + " ]";
    }
