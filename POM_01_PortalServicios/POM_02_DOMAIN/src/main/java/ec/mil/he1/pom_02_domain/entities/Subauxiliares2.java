...
public class Subauxiliares2 implements Serializable {
    ...
    @OneToMany(cascade = CascadeType.ALL, mappedBy = "subauxiliares2", fetch = FetchType.LAZY)
    private List<Subauxiliares3> subauxiliares3List;
    @JoinColumns({
        @JoinColumn(name = "S_A_SC_CNT_MYR_EMP_CODIGO", referencedColumnName = "A_SC_CNT_MYR_EMP_CODIGO", insertable = false, updatable = false),
        @JoinColumn(name = "S_A_SC_CNT_MYR_CODIGO", referencedColumnName = "A_SC_CNT_MYR_CODIGO", insertable = false, updatable = false),
        @JoinColumn(name = "S_A_SC_CNT_CODIGO", referencedColumnName = "A_SC_CNT_CODIGO", insertable = false, updatable = false),
        @JoinColumn(name = "S_A_SC_CODIGO", referencedColumnName = "A_SC_CODIGO", insertable = false, updatable = false),
        @JoinColumn(name = "S_A_CODIGO", referencedColumnName = "A_CODIGO", insertable = false, updatable = false),
        @JoinColumn(name = "S_CODIGO", referencedColumnName = "CODIGO", insertable = false, updatable = false)})
    @ManyToOne(optional = false, fetch = FetchType.LAZY)
    private Subauxiliares subauxiliares;
    ...
    public List<Subauxiliares3> getSubauxiliares3List() {
        return subauxiliares3List;
    }

    public void setSubauxiliares3List(List<Subauxiliares3> subauxiliares3List) {
        this.subauxiliares3List = subauxiliares3List;
    }

    public Subauxiliares getSubauxiliares() {
        return subauxiliares;
    }

    public void setSubauxiliares(Subauxiliares subauxiliares) {
        this.subauxiliares = subauxiliares;
    }
    ...
    public String toString() {
        return "ec.mil.he1.pom_02_domain.entities.Subauxiliares2[ subauxiliares2PK=" + subauxiliares2PK + " ]";
    }
