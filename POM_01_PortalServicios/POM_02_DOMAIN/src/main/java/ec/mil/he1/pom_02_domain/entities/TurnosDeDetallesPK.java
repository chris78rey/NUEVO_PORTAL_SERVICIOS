 ...
 */
@Embeddable
public class TurnosDeDetallesPK implements Serializable {
    ...
    public TurnosDeDetallesPK() {
    }

    public TurnosDeDetallesPK(String dprAraCodigo, String dprCodigo, Date fecha, int numero) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof TurnosDeDetallesPK)) {
            return false;
        }
        TurnosDeDetallesPK other = (TurnosDeDetallesPK) object;
    ...
    public String toString() {
        return "ec.mil.he1.pom_02_domain.entities.TurnosDeDetallesPK[ dprAraCodigo=" + dprAraCodigo + ", dprCodigo=" + dprCodigo + ", fecha=" + fecha + ", numero=" + numero + " ]";
    }
