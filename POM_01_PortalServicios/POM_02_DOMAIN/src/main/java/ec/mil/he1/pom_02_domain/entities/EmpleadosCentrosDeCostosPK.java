...
public class EmpleadosCentrosDeCostosPK implements Serializable {
    ...
    public String toString() {
        return "ec.mil.he1.pom_02_domain.entities.EmpleadosCentrosDeCostosPK[ emprolEmpCodigo=" + emprolEmpCodigo + ", emprolCodigo=" + emprolCodigo + ", cntcstTipo=" + cntcstTipo + ", cntcstEmpCodigo=" + cntcstEmpCodigo + ", cntcstAgrupador=" + cntcstAgrupador + " ]";
    }
