...
public class AsociacionesComprobante implements Serializable {
    ...
    @JoinColumns({
        @JoinColumn(name = "ASCTPOCMP_TPOCMP_CODIGO", referencedColumnName = "TPOCMP_CODIGO", insertable = false, updatable = false),
        @JoinColumn(name = "ASCTPOCMP_NOMBRE", referencedColumnName = "NOMBRE", insertable = false, updatable = false)})
    @ManyToOne(optional = false, fetch = FetchType.LAZY)
    private AsociacionesTipoDeComproban asociacionesTipoDeComproban;
    ...
    public AsociacionesTipoDeComproban getAsociacionesTipoDeComproban() {
        return asociacionesTipoDeComproban;
    }

    public void setAsociacionesTipoDeComproban(AsociacionesTipoDeComproban asociacionesTipoDeComproban) {
        this.asociacionesTipoDeComproban = asociacionesTipoDeComproban;
    }
    ...
    public String toString() {
        return "ec.mil.he1.pom_02_domain.entities.AsociacionesComprobante[ asociacionesComprobantePK=" + asociacionesComprobantePK + " ]";
    }
