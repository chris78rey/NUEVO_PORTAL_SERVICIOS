...
public class DetallesDescargo implements Serializable {
    ...
    @JoinColumn(name = "DSCBTC_NUMERO", referencedColumnName = "NUMERO", insertable = false, updatable = false)
    ...
    public String toString() {
        return "ec.mil.he1.pom_02_domain.entities.DetallesDescargo[ detallesDescargoPK=" + detallesDescargoPK + " ]";
    }
