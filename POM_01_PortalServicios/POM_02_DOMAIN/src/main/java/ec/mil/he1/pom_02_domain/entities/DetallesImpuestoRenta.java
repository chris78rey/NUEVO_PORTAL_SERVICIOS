...
public class DetallesImpuestoRenta implements Serializable {
    ...
    @JoinColumn(name = "TBLIMPRNT_ANO_RIGE", referencedColumnName = "ANO_RIGE", insertable = false, updatable = false)
    @ManyToOne(optional = false, fetch = FetchType.LAZY)
    private TablasImpuestoRenta tablasImpuestoRenta;
    ...
    public TablasImpuestoRenta getTablasImpuestoRenta() {
        return tablasImpuestoRenta;
    }

    public void setTablasImpuestoRenta(TablasImpuestoRenta tablasImpuestoRenta) {
        this.tablasImpuestoRenta = tablasImpuestoRenta;
    }
    ...
    public String toString() {
        return "ec.mil.he1.pom_02_domain.entities.DetallesImpuestoRenta[ detallesImpuestoRentaPK=" + detallesImpuestoRentaPK + " ]";
    }
