...
public class ParametrosPerfilesPK implements Serializable {
    ...
    public String toString() {
        return "ec.mil.he1.pom_02_domain.entities.ParametrosPerfilesPK[ prmrolCodigo=" + prmrolCodigo + ", prfempCodigo=" + prfempCodigo + ", prmrolEmpCodigo=" + prmrolEmpCodigo + ", prfempEmpCodigo=" + prfempEmpCodigo + " ]";
    }
