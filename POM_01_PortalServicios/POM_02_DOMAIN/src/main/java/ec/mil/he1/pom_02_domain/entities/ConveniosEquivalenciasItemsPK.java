...
public class ConveniosEquivalenciasItemsPK implements Serializable {
    ...
    public String toString() {
        return "ec.mil.he1.pom_02_domain.entities.ConveniosEquivalenciasItemsPK[ trfitmCnvConvenio=" + trfitmCnvConvenio + ", trfitmAtiAnexo=" + trfitmAtiAnexo + ", trfitmTipo=" + trfitmTipo + ", trfitmCodigo=" + trfitmCodigo + ", itmTipo=" + itmTipo + ", itmCodigo=" + itmCodigo + ", itmSbsCodigo=" + itmSbsCodigo + ", itmSbsSccCodigo=" + itmSbsSccCodigo + " ]";
    }
