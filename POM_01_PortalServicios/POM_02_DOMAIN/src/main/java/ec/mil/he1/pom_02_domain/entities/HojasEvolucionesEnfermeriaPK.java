...
public class HojasEvolucionesEnfermeriaPK implements Serializable {
    ...
    public String toString() {
        return "ec.mil.he1.pom_02_domain.entities.HojasEvolucionesEnfermeriaPK[ prmatnPcnNumeroHc=" + prmatnPcnNumeroHc + ", prmatnNumero=" + prmatnNumero + ", turno=" + turno + ", fecha=" + fecha + " ]";
    }
