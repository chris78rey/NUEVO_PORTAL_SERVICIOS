...
public class DetallesDeCostosPK implements Serializable {
    ...
    public String toString() {
        return "ec.mil.he1.pom_02_domain.entities.DetallesDeCostosPK[ elmcstprdElmcstNumero=" + elmcstprdElmcstNumero + ", elmcstprdPrdNumero=" + elmcstprdPrdNumero + ", cstCodigo=" + cstCodigo + ", agncstTipo=" + agncstTipo + ", agncstCodigo=" + agncstCodigo + " ]";
    }
