 ...
 */
@Embeddable
public class ComplicacionesPostanestesicasPK implements Serializable {
    ...
    public ComplicacionesPostanestesicasPK() {
    }

    public ComplicacionesPostanestesicasPK(int prtoprslcPcnNumeroHc, int prtoprslcNumero, String complicacion) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof ComplicacionesPostanestesicasPK)) {
            return false;
        }
        ComplicacionesPostanestesicasPK other = (ComplicacionesPostanestesicasPK) object;
    ...
    public String toString() {
        return "ec.mil.he1.pom_02_domain.entities.ComplicacionesPostanestesicasPK[ prtoprslcPcnNumeroHc=" + prtoprslcPcnNumeroHc + ", prtoprslcNumero=" + prtoprslcNumero + ", complicacion=" + complicacion + " ]";
    }
