...
public class ImportacionesNcNdSri implements Serializable {
    ...
    @JoinColumns({
        @JoinColumn(name = "IMPSRI_PERIODO", referencedColumnName = "PERIODO", insertable = false, updatable = false),
        @JoinColumn(name = "IMPSRI_EMP_CODIGO", referencedColumnName = "EMP_CODIGO", insertable = false, updatable = false)})
    ...
    public String toString() {
        return "ec.mil.he1.pom_02_domain.entities.ImportacionesNcNdSri[ importacionesNcNdSriPK=" + importacionesNcNdSriPK + " ]";
    }
