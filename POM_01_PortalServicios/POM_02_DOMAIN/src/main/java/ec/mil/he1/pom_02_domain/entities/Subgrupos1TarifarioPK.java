...
public class Subgrupos1TarifarioPK implements Serializable {
    ...
    public String toString() {
        return "ec.mil.he1.pom_02_domain.entities.Subgrupos1TarifarioPK[ convenio=" + convenio + ", tipo=" + tipo + ", sbgtrfGrptrfCodigo=" + sbgtrfGrptrfCodigo + ", sbgtrfCodigo=" + sbgtrfCodigo + ", codigo=" + codigo + " ]";
    }
