...
public class NotaCreditoElectronicaDtl implements Serializable {
    ...
    @JoinColumns({
        @JoinColumn(name = "NCES_NCR_CAJA", referencedColumnName = "NCR_CAJA", insertable = false, updatable = false),
        @JoinColumn(name = "NCES_NCR_NUMERO", referencedColumnName = "NCR_NUMERO", insertable = false, updatable = false)})
    @ManyToOne(optional = false, fetch = FetchType.LAZY)
    private NotaCreditoElectronica notaCreditoElectronica;
    @OneToMany(mappedBy = "notaCreditoElectronicaDtl", fetch = FetchType.LAZY)
    private List<DtlimpNcrElectronica> dtlimpNcrElectronicaList;
    ...
    public List<DtlimpNcrElectronica> getDtlimpNcrElectronicaList() {
        return dtlimpNcrElectronicaList;
    }

    public void setDtlimpNcrElectronicaList(List<DtlimpNcrElectronica> dtlimpNcrElectronicaList) {
        this.dtlimpNcrElectronicaList = dtlimpNcrElectronicaList;
    }
    ...
    public String toString() {
        return "ec.mil.he1.pom_02_domain.entities.NotaCreditoElectronicaDtl[ notaCreditoElectronicaDtlPK=" + notaCreditoElectronicaDtlPK + " ]";
    }
