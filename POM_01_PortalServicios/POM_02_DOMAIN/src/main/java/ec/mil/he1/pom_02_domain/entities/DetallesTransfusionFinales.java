...
public class DetallesTransfusionFinales implements Serializable {
    ...
    @JoinColumn(name = "TRS_NUMERO", referencedColumnName = "NUMERO", insertable = false, updatable = false)
    @ManyToOne(optional = false, fetch = FetchType.LAZY)
    private Transfusiones transfusiones;
    ...
    public Transfusiones getTransfusiones() {
        return transfusiones;
    }

    public void setTransfusiones(Transfusiones transfusiones) {
    ...
    public String toString() {
        return "ec.mil.he1.pom_02_domain.entities.DetallesTransfusionFinales[ detallesTransfusionFinalesPK=" + detallesTransfusionFinalesPK + " ]";
    }
