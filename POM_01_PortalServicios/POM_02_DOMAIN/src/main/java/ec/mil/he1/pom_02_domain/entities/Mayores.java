...
public class Mayores implements Serializable {
    ...
    @OneToMany(cascade = CascadeType.ALL, mappedBy = "mayores", fetch = FetchType.LAZY)
    private List<CuentasPlan> cuentasPlanList;
    ...
    public List<CuentasPlan> getCuentasPlanList() {
        return cuentasPlanList;
    }

    public void setCuentasPlanList(List<CuentasPlan> cuentasPlanList) {
        this.cuentasPlanList = cuentasPlanList;
    }
    ...
    public String toString() {
        return "ec.mil.he1.pom_02_domain.entities.Mayores[ mayoresPK=" + mayoresPK + " ]";
    }
