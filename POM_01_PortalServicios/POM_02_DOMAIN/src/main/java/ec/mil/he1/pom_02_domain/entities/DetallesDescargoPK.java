...
public class DetallesDescargoPK implements Serializable {
    ...
    public String toString() {
        return "ec.mil.he1.pom_02_domain.entities.DetallesDescargoPK[ dscbtcNumero=" + dscbtcNumero + ", itmTipo=" + itmTipo + ", itmCodigo=" + itmCodigo + ", itmSbsCodigo=" + itmSbsCodigo + ", itmSbsSccCodigo=" + itmSbsSccCodigo + " ]";
    }
