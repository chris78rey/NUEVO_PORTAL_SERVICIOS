 ...
 */
@Embeddable
public class CuentasExtrasPK implements Serializable {
    ...
    public CuentasExtrasPK() {
    }

    public CuentasExtrasPK(String cntsDocumento, long cntsNumero, long cntsDetalle, Character cntsSeguro, String sessionId) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof CuentasExtrasPK)) {
            return false;
        }
        CuentasExtrasPK other = (CuentasExtrasPK) object;
    ...
    public String toString() {
        return "ec.mil.he1.pom_02_domain.entities.CuentasExtrasPK[ cntsDocumento=" + cntsDocumento + ", cntsNumero=" + cntsNumero + ", cntsDetalle=" + cntsDetalle + ", cntsSeguro=" + cntsSeguro + ", sessionId=" + sessionId + " ]";
    }
