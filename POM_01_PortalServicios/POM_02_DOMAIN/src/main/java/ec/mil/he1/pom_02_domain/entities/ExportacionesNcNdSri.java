...
public class ExportacionesNcNdSri implements Serializable {
    ...
    @JoinColumns({
        @JoinColumn(name = "EXPSRI_PERIODO", referencedColumnName = "PERIODO", insertable = false, updatable = false),
        @JoinColumn(name = "EXPSRI_EMP_CODIGO", referencedColumnName = "EMP_CODIGO", insertable = false, updatable = false)})
    ...
    public String toString() {
        return "ec.mil.he1.pom_02_domain.entities.ExportacionesNcNdSri[ exportacionesNcNdSriPK=" + exportacionesNcNdSriPK + " ]";
    }
