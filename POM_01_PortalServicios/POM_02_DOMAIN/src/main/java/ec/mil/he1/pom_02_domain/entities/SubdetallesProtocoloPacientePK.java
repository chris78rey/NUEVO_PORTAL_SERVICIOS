...
public class SubdetallesProtocoloPacientePK implements Serializable {
    ...
    public String toString() {
        return "ec.mil.he1.pom_02_domain.entities.SubdetallesProtocoloPacientePK[ sdvpCodigo=" + sdvpCodigo + ", sdvpVprtCodigo=" + sdvpVprtCodigo + ", sdvpVprtPCodigo=" + sdvpVprtPCodigo + ", vppPpPcnHc=" + vppPpPcnHc + ", vppPpPCodigo=" + vppPpPCodigo + ", vppVpCodigo=" + vppVpCodigo + ", vppVpPCodigo=" + vppVpPCodigo + ", vppVpFecha=" + vppVpFecha + " ]";
    }
