...
public class Subauxiliares2PK implements Serializable {
    ...
    public String toString() {
        return "ec.mil.he1.pom_02_domain.entities.Subauxiliares2PK[ sAScCntMyrEmpCodigo=" + sAScCntMyrEmpCodigo + ", sAScCntMyrCodigo=" + sAScCntMyrCodigo + ", sAScCntCodigo=" + sAScCntCodigo + ", sAScCodigo=" + sAScCodigo + ", sACodigo=" + sACodigo + ", sCodigo=" + sCodigo + ", codigo=" + codigo + " ]";
    }
