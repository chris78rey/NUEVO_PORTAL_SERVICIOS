...
public class CierresDeMes implements Serializable {
    ...
    @OneToMany(cascade = CascadeType.ALL, mappedBy = "cierresDeMes", fetch = FetchType.LAZY)
    ...
    public String toString() {
        return "ec.mil.he1.pom_02_domain.entities.CierresDeMes[ cierresDeMesPK=" + cierresDeMesPK + " ]";
    }
