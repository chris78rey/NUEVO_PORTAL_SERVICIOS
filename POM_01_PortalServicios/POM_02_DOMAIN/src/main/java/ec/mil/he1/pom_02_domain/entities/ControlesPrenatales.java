...
public class ControlesPrenatales implements Serializable {
    ...
    private Short afu;
    @JoinColumns({
        @JoinColumn(name = "EMB_PCN_NUMERO_HC", referencedColumnName = "PCN_NUMERO_HC", insertable = false, updatable = false),
        @JoinColumn(name = "EMB_NUMERO", referencedColumnName = "NUMERO", insertable = false, updatable = false)})
    ...
    public String toString() {
        return "ec.mil.he1.pom_02_domain.entities.ControlesPrenatales[ controlesPrenatalesPK=" + controlesPrenatalesPK + " ]";
    }
