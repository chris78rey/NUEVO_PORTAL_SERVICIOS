...
public class RetencionesRelacionDependencPK implements Serializable {
    ...
    public String toString() {
        return "ec.mil.he1.pom_02_domain.entities.RetencionesRelacionDependencPK[ rtnfntEmpCodigo=" + rtnfntEmpCodigo + ", rtnfntAnio=" + rtnfntAnio + ", rtnfntTipo=" + rtnfntTipo + ", identificacionEmp=" + identificacionEmp + ", rtnfntMes=" + rtnfntMes + " ]";
    }
