...
public class RetencionesElectronicasPK implements Serializable {
    ...
    public String toString() {
        return "ec.mil.he1.pom_02_domain.entities.RetencionesElectronicasPK[ cmpTpocmpempEmpCodigo=" + cmpTpocmpempEmpCodigo + ", cmpTpocmpempTpocmpCodigo=" + cmpTpocmpempTpocmpCodigo + ", cmpFecha=" + cmpFecha + ", cmpClave=" + cmpClave + ", rtnCaja=" + rtnCaja + " ]";
    }
