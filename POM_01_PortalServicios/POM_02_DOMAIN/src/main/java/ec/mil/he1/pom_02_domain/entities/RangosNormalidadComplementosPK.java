...
public class RangosNormalidadComplementosPK implements Serializable {
    ...
    public String toString() {
        return "ec.mil.he1.pom_02_domain.entities.RangosNormalidadComplementosPK[ cmplmtCodigo=" + cmplmtCodigo + ", edadInferior=" + edadInferior + ", sexo=" + sexo + ", fechaDeCreacion=" + fechaDeCreacion + ", estadoDeActividad=" + estadoDeActividad + " ]";
    }
