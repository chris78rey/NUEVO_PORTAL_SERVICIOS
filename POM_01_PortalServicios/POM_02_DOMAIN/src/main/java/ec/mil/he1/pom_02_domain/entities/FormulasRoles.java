...
public class FormulasRoles implements Serializable {
    ...
    @OneToMany(mappedBy = "formulasRoles", fetch = FetchType.LAZY)
    private List<ParametrosFormulas> parametrosFormulasList;
    @OneToMany(cascade = CascadeType.ALL, mappedBy = "formulasRoles", fetch = FetchType.LAZY)
    private List<GruposDetalles> gruposDetallesList;
    ...
    public List<ParametrosFormulas> getParametrosFormulasList() {
        return parametrosFormulasList;
    }

    public void setParametrosFormulasList(List<ParametrosFormulas> parametrosFormulasList) {
        this.parametrosFormulasList = parametrosFormulasList;
    }

    public List<GruposDetalles> getGruposDetallesList() {
        return gruposDetallesList;
    }

    public void setGruposDetallesList(List<GruposDetalles> gruposDetallesList) {
        this.gruposDetallesList = gruposDetallesList;
    }
    ...
    public String toString() {
        return "ec.mil.he1.pom_02_domain.entities.FormulasRoles[ formulasRolesPK=" + formulasRolesPK + " ]";
    }
