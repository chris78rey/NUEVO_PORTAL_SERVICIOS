...
public class ActivosFijosEspecificosPK implements Serializable {
    ...
    public String toString() {
        return "ec.mil.he1.pom_02_domain.entities.ActivosFijosEspecificosPK[ sbgactfjoGrpactfjoEmpCodigo=" + sbgactfjoGrpactfjoEmpCodigo + ", actfsbgactfjoGrpactfjoCodigo=" + actfsbgactfjoGrpactfjoCodigo + ", actfjognrSbgactfjoCodigo=" + actfjognrSbgactfjoCodigo + ", actfjognrCodigo=" + actfjognrCodigo + ", codigo=" + codigo + " ]";
    }
