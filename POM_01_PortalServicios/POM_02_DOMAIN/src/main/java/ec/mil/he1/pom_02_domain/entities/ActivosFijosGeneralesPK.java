...
public class ActivosFijosGeneralesPK implements Serializable {
    ...
    public String toString() {
        return "ec.mil.he1.pom_02_domain.entities.ActivosFijosGeneralesPK[ sbgactfjoGrpactfjoEmpCodigo=" + sbgactfjoGrpactfjoEmpCodigo + ", sbgactfjoGrpactfjoCodigo=" + sbgactfjoGrpactfjoCodigo + ", sbgactfjoCodigo=" + sbgactfjoCodigo + ", codigo=" + codigo + " ]";
    }
