 ...
 */
@Embeddable
public class BiopsiasDetallesPK implements Serializable {
    ...
    public BiopsiasDetallesPK() {
    }

    public BiopsiasDetallesPK(int exmNumero, int vrbexmCodigo) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof BiopsiasDetallesPK)) {
            return false;
        }
        BiopsiasDetallesPK other = (BiopsiasDetallesPK) object;
    ...
    public String toString() {
        return "ec.mil.he1.pom_02_domain.entities.BiopsiasDetallesPK[ exmNumero=" + exmNumero + ", vrbexmCodigo=" + vrbexmCodigo + " ]";
    }
