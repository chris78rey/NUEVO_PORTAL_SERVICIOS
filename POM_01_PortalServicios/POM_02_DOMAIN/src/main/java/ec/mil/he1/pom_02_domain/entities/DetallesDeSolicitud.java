...
public class DetallesDeSolicitud implements Serializable {
    ...
    @JoinColumn(name = "SLCCMP_CODIGO", referencedColumnName = "CODIGO", insertable = false, updatable = false)
    ...
    public String toString() {
        return "ec.mil.he1.pom_02_domain.entities.DetallesDeSolicitud[ detallesDeSolicitudPK=" + detallesDeSolicitudPK + " ]";
    }
