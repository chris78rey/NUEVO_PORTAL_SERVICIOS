...
public class ComplicacionesTransanestesicaPK implements Serializable {
    ...
    public String toString() {
        return "ec.mil.he1.pom_02_domain.entities.ComplicacionesTransanestesicaPK[ prtoprslcPcnNumeroHc=" + prtoprslcPcnNumeroHc + ", prtoprslcNumero=" + prtoprslcNumero + ", complicacion=" + complicacion + " ]";
    }
