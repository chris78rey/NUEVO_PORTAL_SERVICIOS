...
public class RecuperacionPostAnestesicaPK implements Serializable {
    ...
    public String toString() {
        return "ec.mil.he1.pom_02_domain.entities.RecuperacionPostAnestesicaPK[ rgsoprPrsCodigo=" + rgsoprPrsCodigo + ", rgsoprPrtoprslcNumero=" + rgsoprPrtoprslcNumero + ", rgsoprPrtoprslcPcnNumeroHc=" + rgsoprPrtoprslcPcnNumeroHc + " ]";
    }
