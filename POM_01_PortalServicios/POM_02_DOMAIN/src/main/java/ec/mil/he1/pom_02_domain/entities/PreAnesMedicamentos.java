...
public class PreAnesMedicamentos implements Serializable {
    ...
    @JoinColumns({
        @JoinColumn(name = "PREANS_RGSOPR_PRTOPRSLC_NUMERO", referencedColumnName = "RGSOPR_PRTOPRSLC_NUMERO", insertable = false, updatable = false),
        @JoinColumn(name = "PREANS_RGSOPR_PRTOPRSLC_PCN_NU", referencedColumnName = "RGSOPR_PRTOPRSLC_PCN_NUMERO_HC", insertable = false, updatable = false)})
    @ManyToOne(optional = false, fetch = FetchType.LAZY)
    private PreAnestesicos preAnestesicos;
    ...
    public PreAnestesicos getPreAnestesicos() {
        return preAnestesicos;
    }

    public void setPreAnestesicos(PreAnestesicos preAnestesicos) {
        this.preAnestesicos = preAnestesicos;
    }
    ...
    public String toString() {
        return "ec.mil.he1.pom_02_domain.entities.PreAnesMedicamentos[ preAnesMedicamentosPK=" + preAnesMedicamentosPK + " ]";
    }
