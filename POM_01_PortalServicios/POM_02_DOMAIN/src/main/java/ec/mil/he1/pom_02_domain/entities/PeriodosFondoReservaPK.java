...
public class PeriodosFondoReservaPK implements Serializable {
    ...
    public String toString() {
        return "ec.mil.he1.pom_02_domain.entities.PeriodosFondoReservaPK[ emprolEmpCodigo=" + emprolEmpCodigo + ", emprolCodigo=" + emprolCodigo + ", fechaDesde=" + fechaDesde + ", fechaHasta=" + fechaHasta + " ]";
    }
