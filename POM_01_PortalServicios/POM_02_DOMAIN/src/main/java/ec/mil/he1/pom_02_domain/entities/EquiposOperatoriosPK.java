...
public class EquiposOperatoriosPK implements Serializable {
    ...
    public String toString() {
        return "ec.mil.he1.pom_02_domain.entities.EquiposOperatoriosPK[ prtoprslcPcnNumeroHc=" + prtoprslcPcnNumeroHc + ", prtoprslcNumero=" + prtoprslcNumero + ", prsCodigo=" + prsCodigo + " ]";
    }
