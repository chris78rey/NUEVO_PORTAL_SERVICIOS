...
public class AsociacionesComprobantePK implements Serializable {
    ...
    public String toString() {
        return "ec.mil.he1.pom_02_domain.entities.AsociacionesComprobantePK[ cmpTpocmpempEmpCodigo=" + cmpTpocmpempEmpCodigo + ", asctpocmpTpocmpCodigo=" + asctpocmpTpocmpCodigo + ", cmpFecha=" + cmpFecha + ", cmpClave=" + cmpClave + ", asctpocmpNombre=" + asctpocmpNombre + " ]";
    }
