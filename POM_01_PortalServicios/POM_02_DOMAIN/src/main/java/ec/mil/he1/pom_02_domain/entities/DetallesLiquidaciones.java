...
public class DetallesLiquidaciones implements Serializable {
    ...
    @JoinColumn(name = "LQD_NUMERO", referencedColumnName = "NUMERO", insertable = false, updatable = false)
    ...
    public String toString() {
        return "ec.mil.he1.pom_02_domain.entities.DetallesLiquidaciones[ detallesLiquidacionesPK=" + detallesLiquidacionesPK + " ]";
    }
