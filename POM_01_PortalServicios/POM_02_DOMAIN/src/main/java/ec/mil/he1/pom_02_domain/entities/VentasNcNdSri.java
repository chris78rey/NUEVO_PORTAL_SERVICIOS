...
public class VentasNcNdSri implements Serializable {
    ...
    @OneToMany(cascade = CascadeType.ALL, mappedBy = "ventasNcNdSri", fetch = FetchType.LAZY)
    private List<RetencionesVentasSri> retencionesVentasSriList;
    @JoinColumns({
    ...
    public List<RetencionesVentasSri> getRetencionesVentasSriList() {
        return retencionesVentasSriList;
    }

    public void setRetencionesVentasSriList(List<RetencionesVentasSri> retencionesVentasSriList) {
        this.retencionesVentasSriList = retencionesVentasSriList;
    }
    ...
    public String toString() {
        return "ec.mil.he1.pom_02_domain.entities.VentasNcNdSri[ ventasNcNdSriPK=" + ventasNcNdSriPK + " ]";
    }
