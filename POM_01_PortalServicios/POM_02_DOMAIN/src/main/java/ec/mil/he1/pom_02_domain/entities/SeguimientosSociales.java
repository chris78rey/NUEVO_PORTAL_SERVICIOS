...
public class SeguimientosSociales implements Serializable {
    ...
    @JoinColumn(name = "GSTSCL_CODIGO", referencedColumnName = "CODIGO", insertable = false, updatable = false)
    @ManyToOne(optional = false, fetch = FetchType.LAZY)
    private GestionesSociales gestionesSociales;
    ...
    public GestionesSociales getGestionesSociales() {
        return gestionesSociales;
    }

    public void setGestionesSociales(GestionesSociales gestionesSociales) {
        this.gestionesSociales = gestionesSociales;
    }
    ...
    public String toString() {
        return "ec.mil.he1.pom_02_domain.entities.SeguimientosSociales[ seguimientosSocialesPK=" + seguimientosSocialesPK + " ]";
    }
