 ...
 */
@Embeddable
public class ItemsProveedoresPK implements Serializable {
    ...
    public ItemsProveedoresPK() {
    }

    public ItemsProveedoresPK(Character itmTipo, String itmSbsSccCodigo, String itmSbsCodigo, short itmCodigo, short prdCodigo) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof ItemsProveedoresPK)) {
            return false;
        }
        ItemsProveedoresPK other = (ItemsProveedoresPK) object;
    ...
    public String toString() {
        return "ec.mil.he1.pom_02_domain.entities.ItemsProveedoresPK[ itmTipo=" + itmTipo + ", itmSbsSccCodigo=" + itmSbsSccCodigo + ", itmSbsCodigo=" + itmSbsCodigo + ", itmCodigo=" + itmCodigo + ", prdCodigo=" + prdCodigo + " ]";
    }
