...
public class DetallesGrpPqtExcPK implements Serializable {
    ...
    public String toString() {
        return "ec.mil.he1.pom_02_domain.entities.DetallesGrpPqtExcPK[ gpexCnvConvenio=" + gpexCnvConvenio + ", gpexCodigo=" + gpexCodigo + ", tipoItem=" + tipoItem + ", tipo=" + tipo + ", codigo=" + codigo + " ]";
    }
