 ...
 */
@Embeddable
public class CotratantesPK implements Serializable {
    ...
    public CotratantesPK() {
    }

    public CotratantesPK(int prmatnNumero, int prmatnPcnNumeroHc, String prsCodigo) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof CotratantesPK)) {
            return false;
        }
        CotratantesPK other = (CotratantesPK) object;
    ...
    public String toString() {
        return "ec.mil.he1.pom_02_domain.entities.CotratantesPK[ prmatnNumero=" + prmatnNumero + ", prmatnPcnNumeroHc=" + prmatnPcnNumeroHc + ", prsCodigo=" + prsCodigo + " ]";
    }
