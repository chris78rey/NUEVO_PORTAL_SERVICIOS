...
public class NotaCreditoElectronica implements Serializable {
    ...
    @OneToMany(mappedBy = "notaCreditoElectronica", fetch = FetchType.LAZY)
    private List<TotimpNcrElectronica> totimpNcrElectronicaList;
    @OneToMany(cascade = CascadeType.ALL, mappedBy = "notaCreditoElectronica", fetch = FetchType.LAZY)
    private List<NotaCreditoElectronicaDtl> notaCreditoElectronicaDtlList;
    ...
    public List<TotimpNcrElectronica> getTotimpNcrElectronicaList() {
        return totimpNcrElectronicaList;
    }

    public void setTotimpNcrElectronicaList(List<TotimpNcrElectronica> totimpNcrElectronicaList) {
        this.totimpNcrElectronicaList = totimpNcrElectronicaList;
    }

    public List<NotaCreditoElectronicaDtl> getNotaCreditoElectronicaDtlList() {
        return notaCreditoElectronicaDtlList;
    }

    public void setNotaCreditoElectronicaDtlList(List<NotaCreditoElectronicaDtl> notaCreditoElectronicaDtlList) {
        this.notaCreditoElectronicaDtlList = notaCreditoElectronicaDtlList;
    }
    ...
    public String toString() {
        return "ec.mil.he1.pom_02_domain.entities.NotaCreditoElectronica[ notaCreditoElectronicaPK=" + notaCreditoElectronicaPK + " ]";
    }
