...
public class MovimientosRolesPK implements Serializable {
    ...
    public String toString() {
        return "ec.mil.he1.pom_02_domain.entities.MovimientosRolesPK[ rolpgsNumero=" + rolpgsNumero + ", rolpgsEmpCodigo=" + rolpgsEmpCodigo + ", emprolEmpCodigo=" + emprolEmpCodigo + ", emprolCodigo=" + emprolCodigo + ", prmrolEmpCodigo=" + prmrolEmpCodigo + ", prmrolCodigo=" + prmrolCodigo + ", numero=" + numero + " ]";
    }
