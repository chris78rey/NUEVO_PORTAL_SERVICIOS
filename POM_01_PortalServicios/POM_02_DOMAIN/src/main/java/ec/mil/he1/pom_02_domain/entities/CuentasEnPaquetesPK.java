...
public class CuentasEnPaquetesPK implements Serializable {
    ...
    public String toString() {
        return "ec.mil.he1.pom_02_domain.entities.CuentasEnPaquetesPK[ numero=" + numero + ", detalle=" + detalle + ", cntsDocumento=" + cntsDocumento + ", cntsNumero=" + cntsNumero + ", cntsDetalle=" + cntsDetalle + ", cntsSeguro=" + cntsSeguro + " ]";
    }
