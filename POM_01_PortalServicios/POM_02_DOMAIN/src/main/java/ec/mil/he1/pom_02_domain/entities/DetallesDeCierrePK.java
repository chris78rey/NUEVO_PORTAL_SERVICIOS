...
public class DetallesDeCierrePK implements Serializable {
    ...
    public String toString() {
        return "ec.mil.he1.pom_02_domain.entities.DetallesDeCierrePK[ rgtcrrAnio=" + rgtcrrAnio + ", rgtcrrMes=" + rgtcrrMes + ", rgtcrrLocal=" + rgtcrrLocal + ", itmTipo=" + itmTipo + ", itmSbsSccCodigo=" + itmSbsSccCodigo + ", itmSbsCodigo=" + itmSbsCodigo + ", itmCodigo=" + itmCodigo + " ]";
    }
