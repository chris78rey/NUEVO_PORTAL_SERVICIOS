...
public class Retenciones implements Serializable {
    ...
    @JoinColumns({
        @JoinColumn(name = "TPORTNEMP_TPORTN_CODIGO", referencedColumnName = "TPORTN_CODIGO", insertable = false, updatable = false),
        @JoinColumn(name = "TPORTNEMP_EMP_CODIGO", referencedColumnName = "EMP_CODIGO", insertable = false, updatable = false)})
    @ManyToOne(optional = false, fetch = FetchType.LAZY)
    private TiposRetencionesEmpresas tiposRetencionesEmpresas;
    @OneToMany(cascade = CascadeType.ALL, mappedBy = "retenciones", fetch = FetchType.LAZY)
    ...
    public TiposRetencionesEmpresas getTiposRetencionesEmpresas() {
        return tiposRetencionesEmpresas;
    }

    public void setTiposRetencionesEmpresas(TiposRetencionesEmpresas tiposRetencionesEmpresas) {
        this.tiposRetencionesEmpresas = tiposRetencionesEmpresas;
    }
    ...
    public String toString() {
        return "ec.mil.he1.pom_02_domain.entities.Retenciones[ retencionesPK=" + retencionesPK + " ]";
    }
