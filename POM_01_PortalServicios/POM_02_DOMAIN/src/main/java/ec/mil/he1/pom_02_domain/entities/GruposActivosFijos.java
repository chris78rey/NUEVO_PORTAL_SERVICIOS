...
public class GruposActivosFijos implements Serializable {
    ...
    @OneToMany(cascade = CascadeType.ALL, mappedBy = "gruposActivosFijos", fetch = FetchType.LAZY)
    private List<SubgruposActivosFijos> subgruposActivosFijosList;
    ...
    public List<SubgruposActivosFijos> getSubgruposActivosFijosList() {
        return subgruposActivosFijosList;
    }

    public void setSubgruposActivosFijosList(List<SubgruposActivosFijos> subgruposActivosFijosList) {
        this.subgruposActivosFijosList = subgruposActivosFijosList;
    }
    ...
    public String toString() {
        return "ec.mil.he1.pom_02_domain.entities.GruposActivosFijos[ gruposActivosFijosPK=" + gruposActivosFijosPK + " ]";
    }
