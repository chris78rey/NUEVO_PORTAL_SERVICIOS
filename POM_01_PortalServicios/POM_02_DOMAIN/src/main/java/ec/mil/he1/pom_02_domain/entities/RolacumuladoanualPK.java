...
public class RolacumuladoanualPK implements Serializable {
    ...
    public String toString() {
        return "ec.mil.he1.pom_02_domain.entities.RolacumuladoanualPK[ raaIdrolacumuladoanual=" + raaIdrolacumuladoanual + ", prnIdpersonal=" + prnIdpersonal + ", raaAnio=" + raaAnio + " ]";
    }
