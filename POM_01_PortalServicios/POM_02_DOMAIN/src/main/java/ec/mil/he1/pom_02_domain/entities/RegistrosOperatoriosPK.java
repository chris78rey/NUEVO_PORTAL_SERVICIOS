 ...
 */
@Embeddable
public class RegistrosOperatoriosPK implements Serializable {
    ...
    public RegistrosOperatoriosPK() {
    }

    public RegistrosOperatoriosPK(int prtoprslcNumero, int prtoprslcPcnNumeroHc, String prsCodigo) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof RegistrosOperatoriosPK)) {
            return false;
        }
        RegistrosOperatoriosPK other = (RegistrosOperatoriosPK) object;
    ...
    public String toString() {
        return "ec.mil.he1.pom_02_domain.entities.RegistrosOperatoriosPK[ prtoprslcNumero=" + prtoprslcNumero + ", prtoprslcPcnNumeroHc=" + prtoprslcPcnNumeroHc + ", prsCodigo=" + prsCodigo + " ]";
    }
