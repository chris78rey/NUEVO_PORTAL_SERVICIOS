...
public class TarifariosItems implements Serializable {
    ...
    @OneToMany(cascade = CascadeType.ALL, mappedBy = "tarifariosItems", fetch = FetchType.LAZY)
    ...
    @JoinColumns({
        ...
        @JoinColumn(name = "ATI_ANEXO", referencedColumnName = "ANEXO", insertable = false, updatable = false)})
    @ManyToOne(optional = false, fetch = FetchType.LAZY)
    private AnexosTarifariosItems anexosTarifariosItems;
    @JoinColumn(name = "CNC_CODIGO", referencedColumnName = "CODIGO")
    @ManyToOne(fetch = FetchType.LAZY)
    private ConcentracionesSns concentracionesSns;
    @JoinColumn(name = "FRM_CODIGO", referencedColumnName = "CODIGO")
    @ManyToOne(fetch = FetchType.LAZY)
    private FormasFaramaceuticasSns formasFaramaceuticasSns;
    @JoinColumn(name = "PNT_CODIGO", referencedColumnName = "CODIGO")
    @ManyToOne(fetch = FetchType.LAZY)
    private PresentacionesSns presentacionesSns;
    @JoinColumn(name = "SNN_CODIGO", referencedColumnName = "CODIGO")
    @ManyToOne(fetch = FetchType.LAZY)
    private SinonimosSns sinonimosSns;
    @JoinColumn(name = "TPI_CODIGO", referencedColumnName = "CODIGO")
    @ManyToOne(fetch = FetchType.LAZY)
    private TiposInsumosSns tiposInsumosSns;
    ...
    public ConcentracionesSns getConcentracionesSns() {
        return concentracionesSns;
    }

    public void setConcentracionesSns(ConcentracionesSns concentracionesSns) {
        this.concentracionesSns = concentracionesSns;
    }

    public FormasFaramaceuticasSns getFormasFaramaceuticasSns() {
        return formasFaramaceuticasSns;
    }

    public void setFormasFaramaceuticasSns(FormasFaramaceuticasSns formasFaramaceuticasSns) {
        this.formasFaramaceuticasSns = formasFaramaceuticasSns;
    }

    public PresentacionesSns getPresentacionesSns() {
        return presentacionesSns;
    }

    public void setPresentacionesSns(PresentacionesSns presentacionesSns) {
        this.presentacionesSns = presentacionesSns;
    }

    public SinonimosSns getSinonimosSns() {
        return sinonimosSns;
    }

    public void setSinonimosSns(SinonimosSns sinonimosSns) {
        this.sinonimosSns = sinonimosSns;
    }

    public TiposInsumosSns getTiposInsumosSns() {
        return tiposInsumosSns;
    }

    public void setTiposInsumosSns(TiposInsumosSns tiposInsumosSns) {
        this.tiposInsumosSns = tiposInsumosSns;
    }
    ...
    public String toString() {
        return "ec.mil.he1.pom_02_domain.entities.TarifariosItems[ tarifariosItemsPK=" + tarifariosItemsPK + " ]";
    }
