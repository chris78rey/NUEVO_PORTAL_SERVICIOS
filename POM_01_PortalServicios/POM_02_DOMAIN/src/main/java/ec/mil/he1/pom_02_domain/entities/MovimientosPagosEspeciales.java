...
public class MovimientosPagosEspeciales implements Serializable {
    ...
    @OneToMany(cascade = CascadeType.ALL, mappedBy = "movimientosPagosEspeciales", fetch = FetchType.LAZY)
    ...
    @JoinColumns({
        @JoinColumn(name = "PAGESPPRMESP_PRMROL_EMP_CODIGO", referencedColumnName = "PRMESP_PRMROL_EMP_CODIGO", insertable = false, updatable = false),
        @JoinColumn(name = "PAGESP_PRMESP_PRMROL_CODIGO", referencedColumnName = "PRMESP_PRMROL_CODIGO", insertable = false, updatable = false),
        @JoinColumn(name = "PAGESP_NUMERO", referencedColumnName = "NUMERO", insertable = false, updatable = false)})
    @ManyToOne(optional = false, fetch = FetchType.LAZY)
    private PagosEspeciales pagosEspeciales;
    ...
    public PagosEspeciales getPagosEspeciales() {
        return pagosEspeciales;
    }

    public void setPagosEspeciales(PagosEspeciales pagosEspeciales) {
    ...
    public String toString() {
        return "ec.mil.he1.pom_02_domain.entities.MovimientosPagosEspeciales[ movimientosPagosEspecialesPK=" + movimientosPagosEspecialesPK + " ]";
    }
