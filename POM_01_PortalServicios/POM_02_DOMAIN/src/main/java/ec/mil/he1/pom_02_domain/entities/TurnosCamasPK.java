...
public class TurnosCamasPK implements Serializable {
    ...
    public TurnosCamasPK(Date fecha, Character ocupada, short cmahspSala, String cmahspCama, int prmNumero, int prmPcnNumeroHc, short numeroAlta) {
        this.fecha = fecha;
    ...
    public boolean equals(Object object) {
        ...
        if (this.numeroAlta != other.numeroAlta) {
            return false;
        }
        return true;
    }
    ...
    public String toString() {
        return "ec.mil.he1.pom_02_domain.entities.TurnosCamasPK[ fecha=" + fecha + ", ocupada=" + ocupada + ", cmahspSala=" + cmahspSala + ", cmahspCama=" + cmahspCama + ", prmNumero=" + prmNumero + ", prmPcnNumeroHc=" + prmPcnNumeroHc + ", numeroAlta=" + numeroAlta + " ]";
    }
