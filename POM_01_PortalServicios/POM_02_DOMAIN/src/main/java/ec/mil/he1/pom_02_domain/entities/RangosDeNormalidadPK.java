...
public class RangosDeNormalidadPK implements Serializable {
    ...
    public String toString() {
        return "ec.mil.he1.pom_02_domain.entities.RangosDeNormalidadPK[ vrbexmCodigo=" + vrbexmCodigo + ", edadInferior=" + edadInferior + ", sexo=" + sexo + ", fechaDeCreacion=" + fechaDeCreacion + ", faseCicloMenstrual=" + faseCicloMenstrual + " ]";
    }
