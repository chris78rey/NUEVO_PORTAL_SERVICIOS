...
public class ControlPersonal implements Serializable {
    ...
    @OneToMany(mappedBy = "controlPersonal", fetch = FetchType.LAZY)
    private List<DetallePermisos> detallePermisosList;
    @OneToMany(cascade = CascadeType.ALL, mappedBy = "controlPersonal", fetch = FetchType.LAZY)
    private List<Asistencias> asistenciasList;
    @OneToMany(mappedBy = "controlPersonal", fetch = FetchType.LAZY)
    private List<DetalleSanciones> detalleSancionesList;
    @OneToMany(mappedBy = "controlPersonal", fetch = FetchType.LAZY)
    private List<DetalleNovedades> detalleNovedadesList;
    ...
    public List<DetallePermisos> getDetallePermisosList() {
        return detallePermisosList;
    }

    public void setDetallePermisosList(List<DetallePermisos> detallePermisosList) {
        this.detallePermisosList = detallePermisosList;
    }
    ...
    public List<DetalleSanciones> getDetalleSancionesList() {
        return detalleSancionesList;
    }

    public void setDetalleSancionesList(List<DetalleSanciones> detalleSancionesList) {
        this.detalleSancionesList = detalleSancionesList;
    }

    public List<DetalleNovedades> getDetalleNovedadesList() {
        return detalleNovedadesList;
    }

    public void setDetalleNovedadesList(List<DetalleNovedades> detalleNovedadesList) {
        this.detalleNovedadesList = detalleNovedadesList;
    }
    ...
    public String toString() {
        return "ec.mil.he1.pom_02_domain.entities.ControlPersonal[ controlPersonalPK=" + controlPersonalPK + " ]";
    }
