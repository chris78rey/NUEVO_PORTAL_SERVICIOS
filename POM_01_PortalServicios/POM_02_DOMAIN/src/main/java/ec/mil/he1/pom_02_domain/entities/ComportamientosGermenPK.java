...
public class ComportamientosGermenPK implements Serializable {
    ...
    public String toString() {
        return "ec.mil.he1.pom_02_domain.entities.ComportamientosGermenPK[ antbtcCodigo=" + antbtcCodigo + ", grmprbDtlexmExmNumero=" + grmprbDtlexmExmNumero + ", grmprbDtlexmVrbexmCodigo=" + grmprbDtlexmVrbexmCodigo + ", grmprbGrmCodigo=" + grmprbGrmCodigo + " ]";
    }
