...
public class RetencionesPK implements Serializable {
    ...
    public String toString() {
        return "ec.mil.he1.pom_02_domain.entities.RetencionesPK[ numero=" + numero + ", tportnempEmpCodigo=" + tportnempEmpCodigo + ", tportnempTportnCodigo=" + tportnempTportnCodigo + " ]";
    }
