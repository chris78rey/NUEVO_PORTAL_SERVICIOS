...
public class NotaCreditoElectronicaDtlPK implements Serializable {
    ...
    public String toString() {
        return "ec.mil.he1.pom_02_domain.entities.NotaCreditoElectronicaDtlPK[ ncesNcrCaja=" + ncesNcrCaja + ", ncesNcrNumero=" + ncesNcrNumero + ", dtlfctDocumento=" + dtlfctDocumento + ", dtlfctNumero=" + dtlfctNumero + ", dtlfctDetalle=" + dtlfctDetalle + ", dtlfctSeguro=" + dtlfctSeguro + " ]";
    }
