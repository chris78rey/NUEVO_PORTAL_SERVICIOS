...
public class VisitasConvenios implements Serializable {
    ...
    @OneToMany(cascade = CascadeType.ALL, mappedBy = "visitasConvenios", fetch = FetchType.LAZY)
    private List<VisitasConveniosDetalles> visitasConveniosDetallesList;
    ...
    public List<VisitasConveniosDetalles> getVisitasConveniosDetallesList() {
        return visitasConveniosDetallesList;
    }

    public void setVisitasConveniosDetallesList(List<VisitasConveniosDetalles> visitasConveniosDetallesList) {
        this.visitasConveniosDetallesList = visitasConveniosDetallesList;
    }
    ...
    public String toString() {
        return "ec.mil.he1.pom_02_domain.entities.VisitasConvenios[ visitasConveniosPK=" + visitasConveniosPK + " ]";
    }
