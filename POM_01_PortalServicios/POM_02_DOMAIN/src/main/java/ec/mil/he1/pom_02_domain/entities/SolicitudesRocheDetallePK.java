...
public class SolicitudesRocheDetallePK implements Serializable {
    ...
    public String toString() {
        return "ec.mil.he1.pom_02_domain.entities.SolicitudesRocheDetallePK[ idCab=" + idCab + ", slcNumero=" + slcNumero + ", exmNumero=" + exmNumero + ", secuencial=" + secuencial + ", vrbexmCodigo=" + vrbexmCodigo + " ]";
    }
