...
public class DetallesAjustes implements Serializable {
    ...
    @JoinColumn(name = "DA_SECUENCIA", referencedColumnName = "SECUENCIA", insertable = false, updatable = false)
    @ManyToOne(optional = false, fetch = FetchType.LAZY)
    private AjustesInventario ajustesInventario;
    @JoinColumns({
    ...
    public AjustesInventario getAjustesInventario() {
        return ajustesInventario;
    }

    public void setAjustesInventario(AjustesInventario ajustesInventario) {
    ...
    public String toString() {
        return "ec.mil.he1.pom_02_domain.entities.DetallesAjustes[ detallesAjustesPK=" + detallesAjustesPK + " ]";
    }
