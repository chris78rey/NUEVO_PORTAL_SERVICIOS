...
public class DetallesEspecialesPK implements Serializable {
    ...
    public String toString() {
        return "ec.mil.he1.pom_02_domain.entities.DetallesEspecialesPK[ pagespprmespPrmrolEmpCodigo=" + pagespprmespPrmrolEmpCodigo + ", mvmpagespPrmespPrmrolCodigo=" + mvmpagespPrmespPrmrolCodigo + ", mvmpagespEmprolEmpCodigo=" + mvmpagespEmprolEmpCodigo + ", mvmpagespEmprolCodigo=" + mvmpagespEmprolCodigo + ", mvmpagespPagespNumero=" + mvmpagespPagespNumero + ", prmrolEmpCodigo=" + prmrolEmpCodigo + ", prmrolCodigo=" + prmrolCodigo + " ]";
    }
