...
public class DetalleCotizacionPK implements Serializable {
    ...
    public String toString() {
        return "ec.mil.he1.pom_02_domain.entities.DetalleCotizacionPK[ itmSbsCodigo=" + itmSbsCodigo + ", itmTipo=" + itmTipo + ", itmSbsSccCodigo=" + itmSbsSccCodigo + ", itmCodigo=" + itmCodigo + ", oceNumero=" + oceNumero + ", prdCodigo=" + prdCodigo + " ]";
    }
