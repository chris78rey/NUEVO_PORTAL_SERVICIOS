...
public class TecnicasCobalto implements Serializable {
    ...
    @JoinColumn(name = "FCHCBL_NUMERO", referencedColumnName = "NUMERO", insertable = false, updatable = false)
    @ManyToOne(optional = false, fetch = FetchType.LAZY)
    private FichasCobaltoterapia fichasCobaltoterapia;
    @OneToMany(mappedBy = "tecnicasCobalto", fetch = FetchType.LAZY)
    private List<CamposTratados> camposTratadosList;
    ...
    public FichasCobaltoterapia getFichasCobaltoterapia() {
        return fichasCobaltoterapia;
    }

    public void setFichasCobaltoterapia(FichasCobaltoterapia fichasCobaltoterapia) {
        this.fichasCobaltoterapia = fichasCobaltoterapia;
    }

    public List<CamposTratados> getCamposTratadosList() {
        return camposTratadosList;
    }

    public void setCamposTratadosList(List<CamposTratados> camposTratadosList) {
        this.camposTratadosList = camposTratadosList;
    }
    ...
    public String toString() {
        return "ec.mil.he1.pom_02_domain.entities.TecnicasCobalto[ tecnicasCobaltoPK=" + tecnicasCobaltoPK + " ]";
    }
