...
public class RetencionesComprasSriPK implements Serializable {
    ...
    public String toString() {
        return "ec.mil.he1.pom_02_domain.entities.RetencionesComprasSriPK[ cmpncndsriIvaEmpCodigo=" + cmpncndsriIvaEmpCodigo + ", cmpncndsriIvaPeriodo=" + cmpncndsriIvaPeriodo + ", cmpncndsriNumero=" + cmpncndsriNumero + ", codigoRf=" + codigoRf + " ]";
    }
