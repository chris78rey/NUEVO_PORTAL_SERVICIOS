...
public class DatosIntervienenPK implements Serializable {
    ...
    public String toString() {
        return "ec.mil.he1.pom_02_domain.entities.DatosIntervienenPK[ prmespPrmrolEmpCodigo=" + prmespPrmrolEmpCodigo + ", prmespPrmrolCodigo=" + prmespPrmrolCodigo + ", prmrolEmpCodigo=" + prmrolEmpCodigo + ", prmrolCodigo=" + prmrolCodigo + " ]";
    }
