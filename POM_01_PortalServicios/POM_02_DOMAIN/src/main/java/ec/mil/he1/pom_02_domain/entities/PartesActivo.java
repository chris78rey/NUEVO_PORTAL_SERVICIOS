...
public class PartesActivo implements Serializable {
    ...
    @JoinColumns({
        ...
        @JoinColumn(name = "ACTFSBGACTFJO_GRPACTFJO_CODIGO", referencedColumnName = "ACTFSBGACTFJO_GRPACTFJO_CODIGO", insertable = false, updatable = false),
        @JoinColumn(name = "ACTFACTFJOGNR_SBGACTFJO_CODIGO", referencedColumnName = "ACTFJOGNR_SBGACTFJO_CODIGO", insertable = false, updatable = false),
        @JoinColumn(name = "ACTFJOESP_ACTFJOGNR_CODIGO", referencedColumnName = "ACTFJOGNR_CODIGO", insertable = false, updatable = false),
        @JoinColumn(name = "ACTFJOESP_CODIGO", referencedColumnName = "CODIGO", insertable = false, updatable = false)})
    ...
    public String toString() {
        return "ec.mil.he1.pom_02_domain.entities.PartesActivo[ partesActivoPK=" + partesActivoPK + " ]";
    }
