...
public class OtrosTiposRetencionesPK implements Serializable {
    ...
    public String toString() {
        return "ec.mil.he1.pom_02_domain.entities.OtrosTiposRetencionesPK[ rtnfntsriEmpCodigo=" + rtnfntsriEmpCodigo + ", rtnfntsriAnio=" + rtnfntsriAnio + ", rtnfntsriTipo=" + rtnfntsriTipo + ", numero=" + numero + " ]";
    }
