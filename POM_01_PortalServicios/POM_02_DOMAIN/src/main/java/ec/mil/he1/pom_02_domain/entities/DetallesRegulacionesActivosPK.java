...
public class DetallesRegulacionesActivosPK implements Serializable {
    ...
    public String toString() {
        return "ec.mil.he1.pom_02_domain.entities.DetallesRegulacionesActivosPK[ rglactfjoEmpCodigo=" + rglactfjoEmpCodigo + ", rglactfjoNumero=" + rglactfjoNumero + ", numero=" + numero + " ]";
    }
