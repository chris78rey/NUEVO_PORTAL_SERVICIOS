...
public class PreAnesMedicamentosPK implements Serializable {
    ...
    public String toString() {
        return "ec.mil.he1.pom_02_domain.entities.PreAnesMedicamentosPK[ preansRgsoprPrtoprslcPcnNu=" + preansRgsoprPrtoprslcPcnNu + ", preansRgsoprPrtoprslcNumero=" + preansRgsoprPrtoprslcNumero + ", fecha=" + fecha + " ]";
    }
