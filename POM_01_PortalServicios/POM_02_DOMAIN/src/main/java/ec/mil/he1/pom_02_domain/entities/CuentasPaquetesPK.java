...
public class CuentasPaquetesPK implements Serializable {
    ...
    public String toString() {
        return "ec.mil.he1.pom_02_domain.entities.CuentasPaquetesPK[ cntsDocumento=" + cntsDocumento + ", cntsNumero=" + cntsNumero + ", cntsDetalle=" + cntsDetalle + ", cntsSeguro=" + cntsSeguro + ", sessionId=" + sessionId + " ]";
    }
