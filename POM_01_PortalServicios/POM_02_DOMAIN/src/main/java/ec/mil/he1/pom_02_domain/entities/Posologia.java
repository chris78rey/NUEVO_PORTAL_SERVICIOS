...
public class Posologia implements Serializable {
    ...
    @JoinColumns({
        @JoinColumn(name = "PGA_GEN_CODIGO_P", referencedColumnName = "GEN_CODIGO_P", insertable = false, updatable = false),
        @JoinColumn(name = "PGA_PRE_CODIGO", referencedColumnName = "PRE_CODIGO", insertable = false, updatable = false)})
    ...
    public String toString() {
        return "ec.mil.he1.pom_02_domain.entities.Posologia[ posologiaPK=" + posologiaPK + " ]";
    }
