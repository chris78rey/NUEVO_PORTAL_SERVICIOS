 ...
 */
@Embeddable
public class PartesOperatoriosPK implements Serializable {
    ...
    public PartesOperatoriosPK() {
    }

    public PartesOperatoriosPK(int prtoprslcPcnNumeroHc, int prtoprslcNumero) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof PartesOperatoriosPK)) {
            return false;
        }
        PartesOperatoriosPK other = (PartesOperatoriosPK) object;
    ...
    public String toString() {
        return "ec.mil.he1.pom_02_domain.entities.PartesOperatoriosPK[ prtoprslcPcnNumeroHc=" + prtoprslcPcnNumeroHc + ", prtoprslcNumero=" + prtoprslcNumero + " ]";
    }
