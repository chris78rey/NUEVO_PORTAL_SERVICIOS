 ...
 */
@Embeddable
public class VisitasConveniosPK implements Serializable {
    ...
    public VisitasConveniosPK() {
    }

    public VisitasConveniosPK(String valor, String cnvConvenio) {
        this.valor = valor;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof VisitasConveniosPK)) {
            return false;
        }
        VisitasConveniosPK other = (VisitasConveniosPK) object;
    ...
    public String toString() {
        return "ec.mil.he1.pom_02_domain.entities.VisitasConveniosPK[ valor=" + valor + ", cnvConvenio=" + cnvConvenio + " ]";
    }
