...
public class Fraccionamientos implements Serializable {
    ...
    @JoinColumn(name = "FRN_CODIGO", referencedColumnName = "CODIGO")
    @ManyToOne(fetch = FetchType.LAZY)
    private Fracciones fracciones;
    @JoinColumn(name = "UND_NUMERO", referencedColumnName = "NUMERO", insertable = false, updatable = false)
    ...
    public String toString() {
        return "ec.mil.he1.pom_02_domain.entities.Fraccionamientos[ fraccionamientosPK=" + fraccionamientosPK + " ]";
    }
