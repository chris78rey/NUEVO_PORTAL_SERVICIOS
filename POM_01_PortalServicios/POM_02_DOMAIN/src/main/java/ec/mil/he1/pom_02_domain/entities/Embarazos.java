...
public class Embarazos implements Serializable {
    ...
    @OneToMany(cascade = CascadeType.ALL, mappedBy = "embarazos", fetch = FetchType.LAZY)
    private List<ControlesPrenatales> controlesPrenatalesList;
    @OneToMany(mappedBy = "embarazos", fetch = FetchType.LAZY)
    ...
    public String toString() {
        return "ec.mil.he1.pom_02_domain.entities.Embarazos[ embarazosPK=" + embarazosPK + " ]";
    }
