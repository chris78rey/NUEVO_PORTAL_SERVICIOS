...
public class ToxicidadesQuimioterapia implements Serializable {
    ...
    @JoinColumn(name = "TPOTXC_CODIGO", referencedColumnName = "CODIGO", insertable = false, updatable = false)
    @ManyToOne(optional = false, fetch = FetchType.LAZY)
    private TipoToxicidad tipoToxicidad;
    ...
    public TipoToxicidad getTipoToxicidad() {
        return tipoToxicidad;
    }

    public void setTipoToxicidad(TipoToxicidad tipoToxicidad) {
    ...
    public String toString() {
        return "ec.mil.he1.pom_02_domain.entities.ToxicidadesQuimioterapia[ toxicidadesQuimioterapiaPK=" + toxicidadesQuimioterapiaPK + " ]";
    }
