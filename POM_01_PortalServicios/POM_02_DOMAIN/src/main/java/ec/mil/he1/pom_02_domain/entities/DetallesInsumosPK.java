 ...
 */
@Embeddable
public class DetallesInsumosPK implements Serializable {
    @Basic(optional = false)
    @Column(name = "SLCINS_NUMERO")
    private int slcinsNumero;
    @Basic(optional = false)
    ...
    public DetallesInsumosPK() {
    }

    public DetallesInsumosPK(int slcinsNumero, Character itmTipo, String itmSbsSccCodigo, String itmSbsCodigo, short itmCodigo) {
    ...
    public int getSlcinsNumero() {
        return slcinsNumero;
    }

    public void setSlcinsNumero(int slcinsNumero) {
        this.slcinsNumero = slcinsNumero;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof DetallesInsumosPK)) {
            return false;
        }
        DetallesInsumosPK other = (DetallesInsumosPK) object;
        if (this.slcinsNumero != other.slcinsNumero) {
            return false;
        }
    ...
    public String toString() {
        return "ec.mil.he1.pom_02_domain.entities.DetallesInsumosPK[ slcinsNumero=" + slcinsNumero + ", itmTipo=" + itmTipo + ", itmSbsSccCodigo=" + itmSbsSccCodigo + ", itmSbsCodigo=" + itmSbsCodigo + ", itmCodigo=" + itmCodigo + " ]";
    }
