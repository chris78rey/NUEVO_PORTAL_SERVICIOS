...
public class TratamientosCobalto implements Serializable {
    ...
    @JoinColumn(name = "CMPTRT_CMPTRT_ID", referencedColumnName = "CMPTRT_ID")
    @ManyToOne(fetch = FetchType.LAZY)
    private CamposTratados camposTratados;
    ...
    public CamposTratados getCamposTratados() {
        return camposTratados;
    }

    public void setCamposTratados(CamposTratados camposTratados) {
        this.camposTratados = camposTratados;
    }
    ...
    public String toString() {
        return "ec.mil.he1.pom_02_domain.entities.TratamientosCobalto[ tratamientosCobaltoPK=" + tratamientosCobaltoPK + " ]";
    }
