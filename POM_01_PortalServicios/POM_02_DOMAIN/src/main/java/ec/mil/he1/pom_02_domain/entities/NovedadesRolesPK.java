...
public class NovedadesRolesPK implements Serializable {
    ...
    public String toString() {
        return "ec.mil.he1.pom_02_domain.entities.NovedadesRolesPK[ rolpgsEmpCodigo=" + rolpgsEmpCodigo + ", rolpgsNumero=" + rolpgsNumero + ", prmrolEmpCodigo=" + prmrolEmpCodigo + ", prmrolCodigo=" + prmrolCodigo + ", emprolEmpCodigo=" + emprolEmpCodigo + ", emprolCodigo=" + emprolCodigo + " ]";
    }
