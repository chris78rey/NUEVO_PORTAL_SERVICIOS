...
public class RetencionesVentasSri implements Serializable {
    ...
    @JoinColumns({
        @JoinColumn(name = "VNTSRI_IVA_EMP_CODIGO", referencedColumnName = "IVA_EMP_CODIGO", insertable = false, updatable = false),
        @JoinColumn(name = "VNTSRI_IVA_PERIODO", referencedColumnName = "IVA_PERIODO", insertable = false, updatable = false),
        @JoinColumn(name = "VNTSRI_NUMERO", referencedColumnName = "NUMERO", insertable = false, updatable = false)})
    @ManyToOne(optional = false, fetch = FetchType.LAZY)
    private VentasNcNdSri ventasNcNdSri;
    ...
    public VentasNcNdSri getVentasNcNdSri() {
        return ventasNcNdSri;
    }

    public void setVentasNcNdSri(VentasNcNdSri ventasNcNdSri) {
        this.ventasNcNdSri = ventasNcNdSri;
    }
    ...
    public String toString() {
        return "ec.mil.he1.pom_02_domain.entities.RetencionesVentasSri[ retencionesVentasSriPK=" + retencionesVentasSriPK + " ]";
    }
