...
public class DetallesManoObraPK implements Serializable {
    ...
    public String toString() {
        return "ec.mil.he1.pom_02_domain.entities.DetallesManoObraPK[ mnoobrdprPrdCodigo=" + mnoobrdprPrdCodigo + ", mnoobrdprClasificacion=" + mnoobrdprClasificacion + ", mnoobrdprDprAraCodigo=" + mnoobrdprDprAraCodigo + ", mnoobrdprDprCodigo=" + mnoobrdprDprCodigo + ", traCodigo=" + traCodigo + " ]";
    }
