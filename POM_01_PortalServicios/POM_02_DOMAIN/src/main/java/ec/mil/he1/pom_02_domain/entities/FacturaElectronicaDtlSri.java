...
public class FacturaElectronicaDtlSri implements Serializable {
    ...
    @OneToMany(mappedBy = "facturaElectronicaDtlSri", fetch = FetchType.LAZY)
    private List<DtlimpFacturaElectronicaSri> dtlimpFacturaElectronicaSriList;
    @JoinColumns({
        @JoinColumn(name = "FCT_CAJA", referencedColumnName = "FCT_CAJA", insertable = false, updatable = false),
        @JoinColumn(name = "FCT_NUMERO", referencedColumnName = "FCT_NUMERO", insertable = false, updatable = false)})
    ...
    public List<DtlimpFacturaElectronicaSri> getDtlimpFacturaElectronicaSriList() {
        return dtlimpFacturaElectronicaSriList;
    }

    public void setDtlimpFacturaElectronicaSriList(List<DtlimpFacturaElectronicaSri> dtlimpFacturaElectronicaSriList) {
        this.dtlimpFacturaElectronicaSriList = dtlimpFacturaElectronicaSriList;
    }
    ...
    public String toString() {
        return "ec.mil.he1.pom_02_domain.entities.FacturaElectronicaDtlSri[ facturaElectronicaDtlSriPK=" + facturaElectronicaDtlSriPK + " ]";
    }
